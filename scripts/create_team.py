...
class Team:
    ...
    personality_types = {
        "INTJ": {"Type": ["Introversion", "Intuition", "Thinking", "Judging"], "Name": "The Architect",
                 ...
                 "KnownCelbrities": ["Thomas Jefferson, U.S. President", "C.S. Lewis, Author",
        ...
        "INTP": {"Type": ["Introversion", "Intuition", "Thinking", "Perceiving"],
                 ...
                 "KnownCelbrities": ["Albert Einstein, Scientist",
                                     "Dwight D. Eisenhower, U.S. President",
                                     "Carl Jung, Psychoanalyst", "Tiger Woods, Golfer",
                                     "Sheldon Cooper, The Big Bang Theory"],
                 "Careers": ["Scientist", "Mathematician", "Engineer", "Dentist", "Doctor", "Teacher",
                             "Judge", "Lawyer"], "ID": "INTP"},
        "ENTJ": {"Type": ["Extroversion", "Intuition", "Thinking", "Judging"], "Name": "The Commander",
                 "AltName": "The Commander", "Class": "fas fa-chess-king", "BGColor": "#99892d",
                 "FTColor": "wheat",
                 ...
                 "KnownCelbrities": ["Franklin D. Roosevelt, U.S. President",
                                     "Bill Gates, Microsoft Founder", "Vince Lombardi, Football Coach",
                                     "Carl Sagan, Astronomer", "Lex Luthor, Superman Character"],
        ...
        "ENTP": {"Type": ["Extroversion", "Intuition", "Thinking", "Perceiving"], "Name": "Debater",
                 ...
                 "Strengths": ["Innovative", "Creative", "Great Conversationalist", "Enjoys Debating",
                               "Values Knowledge"],
                 "Weaknesses": ["Can Be Argumentative", "Dislikes Routines And Schedules",
                                "Does Not Like To Be Controlled", "Unfocused", "Insensitive"],
                 "KnownCelbrities": ["Thomas Edison, Inventor", "John Adams, U.S. President",
                                     "Walt Disney, Filmmaker", "Julia Child, Cook",
                                     "Alexander The Great, King And Military Leader"],
                 "Careers": ["Engineer", "Lawyer", "Scientist", "Psychologist", "Inventor",
                             "Psychiatrist", "Journalist"], "ID": "ENTP"},
        "INFJ": {"Type": ["Introversion", "Intuition", "Feeling", "Judging"], "Name": "Advocate",
                 "AltName": "The Advocate", "Class": "fas fa-hand-holding-heart", "BGColor": "#e57eb1",
                 "FTColor": "wheat",
                 "Description": "Quiet and mystical, yet very inspiring and tireless idealists.",
                 "Dominant": "Introverted Intuition", "Auxiliary": "Extraverted Feeling",
                 "Tertiary": "Introverted Thinking", "Inferior": "Extraverted Sensing",
                 "KeyCharacteristics": [
                 ...
                 "Strengths": ["Sensitive To The Needs Of Others", "Reserved",
                               "Highly Creative And Artistic", "Focused On The Future",
                               "Values Close, Deep Relationships",
                               "Enjoys Thinking About The Meaning Of Life", "Idealistic"],
                 "Weaknesses": ["Can Be Overly Sensitive", "Sometimes Difficult To Get To Know",
                                "Can Have Overly High Expectations", "Stubborn",
                                "Dislikes Confrontation"],
                 "KnownCelbrities": ["Oprah Winfey, Television Personality",
                                     "Martin Luther King, Jr., Civil Rights Leader",
                                     "Atticus Finch, To Kill A Mockingbird",
                                     "Carl Jung, Psychoanalyst", "Taylor Swift, Musician"],
                 "Careers": ["Artist", "Actor", "Entrepreneur", "Religious Worker", "Musician",
                             "Librarian", "Counselor", "Psychologist", "Writer", "Teacher",
                             "Photographer"], "ID": "INFJ"},
        "INFP": {"Type": ["Introversion", "Intuition", "Feeling", "Perceiving"], "Name": "Mediator",
                 "AltName": "The Mediator", "Class": "far fa-handshake", "BGColor": "#213b60",
                 "FTColor": "wheat",
                 "Description": "Poetic, kind and altruistic people, always eager to help a good cause.",
                 "Dominant": "Introverted Feeling", "Auxiliary": "Extraverted Intuition",
                 "Tertiary": "Introverted Sensing", "Inferior": "Extraverted Thinking",
                 "KeyCharacteristics": [
                 ...
                 "Strengths": ["Loyal And Devoted", "Sensitive To Feelings",
                               "Caring And Interested In Others", "Works Well Alone",
                               "Values Close Relationships", "Good At Seeing The Big Picture"],
                 "Weaknesses": ["Can Be Overly Idealistic", "Tends To Take Everything Personally",
                                "Difficult To Get To Know",
                                "Sometimes Loses Sight Of The Little Things", "Overlooks Details"],
                 "KnownCelbrities": ["Audrey Hepburn, Actress", "Jrr Tolkien, Author",
                                     "Princess Diana, British Royal",
                                     "William Shakespeare, Playwright",
                                     "Fred Rogers, Television Personality"],
                 "Careers": ["Artist", "Counselor", "Graphic Designer", "Librarian", "Psychologist",
                             "Physical Therapist", "Social Worker", "Writer"], "ID": "INFP"},
        "ENFJ": {"Type": ["Extroversion", "Intuition", "Feeling", "Judging"], "Name": "Protagonist",
                 "AltName": "The Giver", "Class": "fas fa-people-arrows", "BGColor": "#6f2a4b",
                 "FTColor": "wheat",
                 "Description": "Charismatic and inspiring leaders, able to mesmerize their listeners.",
                 "Dominant": "Extraverted Feeling", "Auxiliary": "Introverted Intuition",
                 "Tertiary": "Extraverted Sensing", "Inferior": "Introverted Thinking",
                 "KeyCharacteristics": [
                 ...
                 "Strengths": ["Outgoing And Warm-Hearted", "Empathetic", "Wide Social Circle",
                               "Encouraging", "Organized"],
                 "Weaknesses": ["Approval-Seeking", "Overly Sensitive", "Indecisive",
                                "Self-Sacrificing"],
                 "KnownCelbrities": ["Abraham Maslow, Psychologist", "Peyton Manning, Football Player",
                                     "Barack Obama, U.S. President", "Bono, Musician",
                                     "Elizabeth Bennet, Character In Pride And Prejudice"],
                 "Careers": ["Counselor", "Teacher", "Psychologist", "Social Worker",
                             "Human Resources Manager", "Sales Representative", "Manager"],
                 "ID": "ENFJ"},
        "ENFP": {"Type": ["Extroversion", "Intuition", "Feeling", "Perceiving"], "Name": "Campaigner",
                 "AltName": "The Champion", "Class": "fas fa-medal", "BGColor": "#c90035",
                 "FTColor": "wheat",
                 "Description": "Enthusiastic, creative and sociable free spirits, who can always find a reason to smile.",
                 "Dominant": "Extraverted Intuition", "Auxiliary": "Introverted Feeling",
                 "Tertiary": "Extraverted Thinking", "Inferior": "Introverted Sensing",
                 "KeyCharacteristics": [
                 ...
                 "Strengths": ["Warm And Enthusiastic", "Empathetic And Caring",
                               "Strong People Skills", "Strong Communication Skills",
                               "Fun And Spontaneous", "Highly Creative"],
                 "Weaknesses": ["Needs Approval From Others", "Disorganized",
                                "Tends To Get Stressed Out Easily", "Can Be Overly Emotional",
                                "Overthinks", "Struggles To Follow Rules"],
                 "KnownCelbrities": ["Andy Kaufmann, Comedian", "Dr. Seuss, Children'S Author",
                                     "Salvador Dali, Artist",
                                     "Ellen Degeneres, Comedian And Talk Show Host",
                                     "Ron Weasley, Harry Potter"],
                 "Careers": ["Psychologist", "Journalist", "Actor", "Tv Anchor/Reporter",
                             "Nutritionist", "Nurse", "Social Worker", "Politician", "Counselor"],
                 "ID": "ENFP"},
        "ISTJ": {"Type": ["Introversion", "Sensing", "Thinking", "Judging"], "Name": "Logistician",
                 "AltName": "The Inspector", "Class": "far fa-eye", "BGColor": "#5d4037",
                 "FTColor": "wheat",
                 ...
                 "KnownCelbrities": ["Mother Teresa, Nun And Humanitarian",
                                     "Louisa May Alcott, Author", "Kristi Yamaguchi, Figure Skater",
                 ...
                 "Careers": ["Social Worker", "Counselor", "Nurse", "Paralegal", "Bookkeeper",
                             ...
                             "Banker", "Accountant"], "ID": "ISTJ"},
        "ISFJ": {"Type": ["Introversion", "Sensing", "Feeling", "Judging"], "Name": "Defender",
                 "AltName": "The Protector", "Class": "fas fa-user-shield", "BGColor": "#ff5627",
                 "FTColor": "wheat",
                 "Description": "Very dedicated and warm protectors, always ready to defend their loved ones.",
                 "Dominant": "Introverted Sensing", "Auxiliary": "Extraverted Feeling",
                 "Tertiary": "Introverted Thinking", "Inferior": "Extraverted Intuition",
                 "KeyCharacteristics": [
        ...
        "ESTJ": {"Type": ["Extroversion", "Sensing", "Thinking", "Judging"], "Name": "Executive",
                 ...
                 "Weaknesses": ["Insensitive", "Inflexible", "Not Good At Expressing Feelings",
                                "Argumentative", "Bossy"],
                 "KnownCelbrities": ["Lyndon B. Johnson, U.S. President",
                                     "Megyn Kelly, Television Personality", "Billy Graham, Evangelist",
                                     "Alec Baldwin, Actor", "Darth Vader, Character From Star Wars"],
        ...
        "ESFJ": {"Type": ["Extroversion", "Sensing", "Feeling", "Judging"], "Name": "Consul",
                 ...
                 "Strengths": ["Kind And Loyal", "Outgoing", "Organized", "Practical And Dependable",
                               "Enjoys Helping Others"],
                 "Weaknesses": ["Needy", "Approval-Seeking", "Sensitive To Criticism"],
                 "KnownCelbrities": ["Sally Field, Actress", "Sam Walton, Wal-Mart Founder",
                                     "William Mckinley, U.S. President",
                                     "Barbara Walters, Television Journalist",
                                     "Joy, Film Character, Inside Out"],
                 "Careers": ["Childcare", "Nursing", "Teaching", "Social Work", "Counseling",
                             "Physician", "Receptionist", "Bookkeeper", "Office Manager"],
                 "ID": "ESFJ"},
        "ISTP": {"Type": ["Introversion", "Sensing", "Thinking", "Perceiving"], "Name": "Virtuoso",
                 "AltName": "The Crafter", "Class": "fas fa-tools", "BGColor": "#c2c0b2",
                 "FTColor": "darkslategray",
                 "Description": "Bold and practical experimenters, masters of all kinds of tools.",
                 "Dominant": "Introverted Thinking", "Auxiliary": "Extraverted Sensing",
                 ...
                 "Strengths": ["Logical", "Learns By Experience", "Action-Oriented",
                               "Realistic And Practical", "Enjoys New Things",
                               "Self-Confident And Easy-Going"],
                 "Weaknesses": ["Difficult To Get To Know", "Insensitive", "Grows Bored Easily",
                                "Risk-Taker", "Does Not Like Commitment"],
                 "KnownCelbrities": ["Clint Eastwood, Actor", "Zachary Taylor, U.S. President",
                                     "Alan Shepherd, Astronaut", "Amelia Earhart, Aviator",
                                     "Han Solo, Star Wars Character"],
                 "Careers": ["Forensic Science", "Engineering", "Mechanics", "Computer Programming",
                             "Carpentry", "Law Enforcement", "Software Engineer",
                             "Video Game Designer", "Electrician", "Scientist", "Pilot",
                             "Firefighter"], "ID": "ISTP"},
        "ISFP": {"Type": ["Introversion", "Sensing", "Feeling", "Perceiving"], "Name": "Adventurer",
                 "AltName": "The Artist", "Class": "fas fa-palette", "BGColor": "#581646",
                 "FTColor": "wheat",
                 "Description": "Flexible and charming artists, always ready to explore and experience something new.",
                 "Dominant": "Introverted Feeling", "Auxiliary": "Extraverted Sensing",
                 "Tertiary": "Introverted Intuition", "Inferior": "Extraverted Thinking",
                 "KeyCharacteristics": [
                 ...
                 "Strengths": ["Very Aware Of Their Environment", "Practical",
                               "Enjoys Hands-On Learning", "Loyal To Values And Beliefs"],
                 "Weaknesses": ["Dislikes Abstract, Theoretical Information", "Reserved And Quiet",
                                "Strong Need For Personal Space", "Dislikes Arguments And Conflict"],
                 "KnownCelbrities": ["Marilyn Monroe, Actress", "Auguste Rodin, Sculptor",
                                     "David Beckham, Soccer Player", "Neil Simon, Playwright",
                                     "Harry Potter, Fictional Character"],
                 "Careers": ["Artist", "Composer Or Musician", "Chef", "Designer", "Forest Ranger",
                             "Nurse", "Naturalist", "Pediatrician", "Psychologist", "Social Worker",
                             "Teacher", "Veterinarian"], "ID": "ISFP"},
        "ESTP": {"Type": ["Extroversion", "Sensing", "Thinking", "Perceiving"], "Name": "Entrepreneur",
                 "AltName": "The Persuader", "Class": "fas fa-briefcase", "BGColor": "#399069",
                 "FTColor": "wheat",
                 "Description": "Smart, energetic and very perceptive people, who truly enjoy living on the edge.",
                 "Dominant": "Extraverted Sensing", "Auxiliary": "Introverted Thinking",
                 "Tertiary": "Extraverted Feeling", "Inferior": "Introverted Intuition",
                 "KeyCharacteristics": [
                 ...
                 "Strengths": ["Gregarious, Funny, And Energetic", "Influential And Persuasive",
                               "Action-Oriented", "Adaptable And Resourceful", "Observant"],
                 "Weaknesses": ["Impulsive", "Competitive", "Dramatic At Times", "Easily Bored",
                                "Insensitive"],
                 "KnownCelbrities": ["Donald Trump, Businessman And U.S. President", "Madonna, Singer",
                                     "Ernest Hemingway, Novelist", "Thomas Edison, Inventor",
                                     "Captain James T. Kirk, Fictional Character, Star Trek"],
                 "Careers": ["Sales Agent", "Marketer", "Entrepreneur", "Police Officers",
                             "Detectives", "Computer Support Technician", "Paramedic"], "ID": "ESTP"},
        "ESFP": {"Type": ["Extroversion", "Sensing", "Feeling", "Perceiving"], "Name": "Entertainer",
                 "AltName": "The Performer", "Class": "fas fa-theater-masks", "BGColor": "#f27149",
                 "FTColor": "wheat",
                 "Description": "Spontaneous, energetic and enthusiastic people.  life is never boring around them.",
                 "Dominant": "Extraverted Sensing", "Auxiliary": "Introverted Feeling",
                 "Tertiary": "Extraverted Thinking", "Inferior": "Introverted Intuition",
                 "KeyCharacteristics": [
                 ...
                 "Strengths": ["Optimistic And Gregarious", "Enjoys People And Socializing",
                               "Focused On The Present, Spontaneous", "Practical"],
                 "Weaknesses": ["Dislikes Abstract Theories", "Becomes Bored Easily",
                                "Does Not Plan Ahead", "Impulsive"],
                 "KnownCelbrities": ["Bill Clinton, U.S. President", "Pablo Picasso, Artist",
                                     "Mark Cuban, Entrepreneur", "Will Smith, Actor",
                                     "Fred And George Weasley, Fictional Characters From Harry Potter"],
                 "Careers": ["Artist", "Actor", "Counselor", "Social Worker", "Athletic Coach",
                             "Child Care Provider", "Musician", "Psychologist",
                             "Human Resources Specialist", "Fashion Designer"], "ID": "ESFP"}
    }
